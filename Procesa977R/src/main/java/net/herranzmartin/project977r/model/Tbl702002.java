...
/**
 * The persistent class for the tbl_702002 database table.
 * 
 */
@Entity
@Table(name="tbl_702002")
public class Tbl702002 implements Serializable {
	...
	@Column(name="DESC_PROVINCIA_DESTINO", length=250)
	private String descProvinciaDestino;

	@Column(name="DESC_PROVINCIA_ORIGEN", length=250)
	...
	@Column(name="NUMERO_DE_LOCUCIONES")
	private int numeroDeLocuciones;

	private int ocurrencias;

	@Column(name="PROVINCIA_DESTINO", length=5)
	private String provinciaDestino;

	@Column(name="PROVINCIA_ORIGEN", length=5)
	...
	public String getDescProvinciaDestino() {
		return this.descProvinciaDestino;
	}
	...
	public String getDescProvinciaOrigen() {
		return this.descProvinciaOrigen;
	}
	...
	public int getNumeroDeLocuciones() {
		return this.numeroDeLocuciones;
	}

	public void setNumeroDeLocuciones(int numeroDeLocuciones) {
		this.numeroDeLocuciones = numeroDeLocuciones;
	}
